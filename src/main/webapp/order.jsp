...
<head>
    <meta charset="utf-8">
    <title>Order - Flexor Bootstrap Theme</title>
                    ...
                    <c:choose>
                        ...
                        <c:otherwise>
                            <form action="order.do" method="POST">
                                <table>
                                    ...
                                    <c:forEach var="product" items="${cart.products}">
                                        <tr data-id="${product.id}">
                                            ...
                                            <td>
                                                <c:out value="${cart.getAmount(product)}" />
                                            </td>
                                            </td>
                                    ...
                                    <tr>
                                        <th><fmt:message key="order.total"/>:
                                            <c:out value="${cart.getTotalPrice()}" />$</th>
                                    </tr>
                                    <tr>

                                        <td><fmt:message key="order.payway"/>: </td>
                                        <td>
                                            <select class="custom-select" name="pay-way">
                                                <option><fmt:message key="order.cash"/></option>
                                                <option id="credit-cart"><fmt:message key="order.creditcart"/></option>
                                            </select>
                                        </td>

                                        <td id="card-data" style="display:none;">
                                ...
                                <button type="submit" class="p-add order"><fmt:message key="order.make.order"/></button>
